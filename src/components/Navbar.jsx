  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[5px] gap-6 ">
      <div className=" lg:flex-1 flex flex-row max-w-[498px]  mb-4 mt-1 py-2 pl-4 pr-2 h-[44px] bg-[#1c1c24] rounded-[100px]">
        <input type="text" placeholder="Search for charities" className="flex w-full font-epilogue font-normal text-[14px] placeholder:text-[#4b5264] text-white bg-transparent outline-none" />

        <div className="w-[42px] h-full rounded-[20px]  flex justify-center items-center cursor-pointer">
